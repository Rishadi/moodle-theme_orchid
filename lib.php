 ...
 * the {@link theme_orchid_less_variables()} here because we need to create selectors or
 * alter existing ones.
 *
 * @param theme_config $theme The theme config object.
 * @return string Raw LESS code.
 */
function theme_orchid_extra_less($theme) {
    $content = '';
 ...
 */
function theme_orchid_less_variables($theme) {
    $variables = array();
 ...
 */
function theme_orchid_process_css($css, $theme) {

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_orchid_set_logo($css, $logo);
    ...
    $css = theme_orchid_set_customcss($css, $customcss);
 ...
 */
function theme_orchid_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_orchid_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM &&
            ($filearea === 'logo' || $filearea === 'smalllogo' || $filearea === 'backgroundimage')) {
        $theme = theme_config::load('orchid');
 ...
 */
function theme_orchid_set_customcss($css, $customcss) {
